      ...
      {data && (
        ...
        >
          ...
          >
            ...
            <p>
              Det er når en bruker ber om en nettside fra en server, serveren
              svarer og sender data til nettleseren. Nettleseren laster ned
              JavaScript og bygger nettsiden. Dette betyr at nettleseren må
              installere all nødvendig JavaScript for å bygge nettsiden, som
              npm-pakker. Dette kan ta mye lastetid og gjør brukeropplevelsen
              dårligere...
            </p>
            <Image
              src={"/klient.webp"}
            ...
            >
              Trykk her for å lese mer om klientkomponenter hvis du vil vite
              mer...
            </Link>
            {data && (
              <>
